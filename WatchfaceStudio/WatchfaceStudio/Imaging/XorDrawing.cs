...
namespace WatchfaceStudio.Imaging
{
    public static class XorDrawing
    {
        ...
        public static void DrawXorRectangle(this System.Drawing.Graphics graphics, System.Drawing.Bitmap bmp, Rectangle rectangle, bool dash = true)
        {
            int oldRop;
            IntPtr oldpen, img;
            int x1 = rectangle.Left, x2 = rectangle.Left + rectangle.Width - 1;
            int y1 = rectangle.Top, y2 = rectangle.Top + rectangle.Height - 1;
            var hdc = BeginDraw(bmp, graphics, x1, y1, x2, y2, dash, out oldRop, out img, out oldpen);
